...
(swig-def-foreign-type "__SWIGACL_FwdReference"
  (* :void))
(swig-def-foreign-class "MicroTestCppClass"
 (ff:foreign-pointer)
  (:class
   ))
...
(swig-defmethod ("curiousGeorge" "ACL___MicroTestCppClass_curiousGeorge__SWIG_0" :type :function :class "MicroTestCppClass" :arity 2)
  ((:p+ PARM0_self #.(swig-insert-id "MicroTestCppClass" () :type :class) (* #.(swig-insert-id "MicroTestCppClass" () :type :type)) )
   (:p+ PARM1_an_int_argument cl:integer :int ))
  (:returning (:int )
   :strings-convert t)
  (cl::let ((ACL_ffresult swig:*void*)
        ACL_result)
  (cl::let ((SWIG_arg0 PARM0_self))
  (cl::let ((SWIG_arg1 PARM1_an_int_argument))
...
(swig-defmethod ("curiousGeorge" "ACL___MicroTestCppClass_curiousGeorge__SWIG_1" :type :function :class "MicroTestCppClass" :arity 1)
  ((:p+ PARM0_self #.(swig-insert-id "MicroTestCppClass" () :type :class) (* #.(swig-insert-id "MicroTestCppClass" () :type :type)) ))
  (:returning (:int )
   :strings-convert t)
  (cl::let ((ACL_ffresult swig:*void*)
...
(swig-dispatcher ("curiousGeorge" :type :function :class "MicroTestCppClass" :arities (1 2)))
(swig-defun ("MicroTestCppClass" "ACL___new_MicroTestCppClass__SWIG_0" :type :constructor)
  (:void)
  (:returning ((* #.(swig-insert-id "MicroTestCppClass" () :type :type)) )
   :strings-convert t)
  (cl::let ((ACL_ffresult swig:*void*)
        ACL_result)
   (cl:let* ((address (swig-ff-call))
	  (new-inst (cl:make-instance '#.(swig-insert-id "MicroTestCppClass" () :type :class) :foreign-address address)))
     (cl:when (cl:and t (cl:not (cl:zerop address)))
       (excl:schedule-finalization new-inst #'#.(swig-insert-id "MicroTestCppClass" () :type :destructor)))
...
(swig-defun ("MicroTestCppClass" "ACL___delete_MicroTestCppClass__SWIG_0" :type :destructor)
  ((:p+ PARM0_self  (* #.(swig-insert-id "MicroTestCppClass" () :type :type)) ))
  (:returning (:void )
   :strings-convert t)
  (cl::let ((ACL_ffresult swig:*void*)
        ACL_result)
